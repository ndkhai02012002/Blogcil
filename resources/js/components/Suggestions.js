                    ...
                    if (res.data.user[i].id == res.data.avatar[i].user_id) {
                        if (list_id.length > 0) {
                            ...
                            if (
                                ...
                                setUser((oldUser) =>[...oldUser,[ [res.data.user[i], res.data.avatar[i]]]]
        ...
        <Fragment>
            {users.map((user) => (
                <Fragment key={user[0][0].id}>
                    <li className={"list-group-item list-group-item-right" + " list-group-item-right-" +  user[0][0].id}>
                        <div className="row">
                            <div className="col-8">
                            ...
                            <div className="col-4" style={{ padding: 0 }}>
                                <button
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setTimeout(() => {
                                            $(".list-group-item-right-"+ user[0][0].id).hide();
                                        },1000);
                                        if (
                                            follow[1] == "true" &&
                                            ...
                                            setFollow([user[0][0].id, "true", id]);
                                        }
                                    }}
                                >
                                    {
                                        ((follow[1] == "true" &&  user[0][0].id==follow[0]) ? (
